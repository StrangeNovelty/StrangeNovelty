...
class AIRequest(models.Model):
    ...
    routing_category = models.CharField(max_length=16, default="writing")
    requested_model = models.CharField(max_length=160, default="deterministic-v1")
...
class AICreativeRequest(models.Model):
    ...
    provider = models.CharField(max_length=32)
    routing_category = models.CharField(max_length=16, default="fallback")
