...
from characters.views import (
    ...
    character_fill_review,
    character_mechanic_setup,
    ...
    relationship_web,
    borrowed_ability_create,
    borrowed_ability_delete,
...
urlpatterns = [
    ...
    path("characters/<uuid:character_id>/delete/", character_delete_view, name="character-delete"),
    path("characters/<uuid:character_id>/fill-from-description/", character_fill_description, name="character-fill-description"),
    path("characters/<uuid:character_id>/fill-from-description/<uuid:proposal_id>/", character_fill_review, name="character-fill-review"),
    path("characters/<uuid:character_id>/ai-assist/", character_ai_assist, name="character-ai-assist"),
    path("characters/<uuid:character_id>/mechanics/setup/", character_mechanic_setup, name="character-mechanic-setup"),
    path("characters/<uuid:character_id>/mechanics/<uuid:membership_id>/borrows/", borrowed_ability_create, name="character-borrow-create"),
    path("characters/<uuid:character_id>/borrows/<uuid:entry_id>/delete/", borrowed_ability_delete, name="character-borrow-delete"),
    path(
        "characters/<uuid:character_id>/personality-traits/",
        personality_trait_create,
        name="character-personality-trait-create",
    ),
    path(
        "characters/<uuid:character_id>/personality-traits/<uuid:trait_id>/delete/",
        personality_trait_delete,
    ...
    path(
        "characters/<uuid:character_id>/<slug:section>/",
        character_detail,
