...
class Migration(migrations.Migration):
    dependencies = [
        ("jobs", "0004_remove_job_job_type_valid_and_more"),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("generate_manuscript_export", "Generate manuscript export"),
                ],
                max_length=32,
            ),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    (
                        "target_category__in",
                        ("system", "workspace", "scene", "import_batch", "ai_request", "export"),
                    )
                ),
                name="job_target_category_valid",
            ),
